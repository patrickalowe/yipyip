...
export const PERMISSION_CATALOG: { value: string; label: string; hint: string }[] = [
  ...
  { value: 'hook:photo-provider', label: 'hook:photo-provider', hint: 'Supply place photos to yipyip' },
  { value: 'hook:calendar-source', label: 'hook:calendar-source', hint: 'Supply calendar events to yipyip' },
