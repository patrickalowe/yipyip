...
This is the yipyip project's policy for the use of our trademarks. While yipyip is
...
be full participants in the yipyip project.

## Our trademarks

This policy covers the name "yipyip" as well as any associated logos, trade dress,
...
say you are distributing yipyip when you're distributing a modified version of it,
...
your website in a way that suggests that your website is an official yipyip
website or that we endorse your website. But, if true, you can say you like
yipyip, that you participate in the yipyip community, that you are providing an
unmodified version of yipyip, or that you wrote a guide describing how to use
yipyip.
...
When you redistribute an unmodified copy of yipyip, you are not changing the
...
you are redistributing an official yipyip distribution that has not been changed
in any way.

## Distribution of executable code that you have compiled, or modified code

You may use the word mark "yipyip", but not any yipyip logos, to truthfully
describe the origin of the software that you are providing, that is, that the
code you are distributing is a modification of yipyip. You may say, for example,
that "this software is derived from the source code for yipyip."
...
executable) on the condition that any executable is built from an official yipyip
...
The following clarifications apply specifically to common ways yipyip is
redistributed:

* **Self-hosted instances of unmodified yipyip.** You may refer to your instance
  as "a yipyip instance" or "running yipyip." You may not name the service itself
  in a way that suggests it is the official yipyip ("yipyip Cloud," "yipyip
  Official," etc.).
* **Mobile wrappers (WebView shells, Capacitor apps, native apps) pointing at
  yipyip.** You may describe your app as "a mobile client for yipyip" or "for use
  with yipyip." You may not publish it on app stores under the name "yipyip" or a
  confusingly similar name, and you may not use the yipyip logo as the app icon
  unless your wrapper distributes only an unmodified, official yipyip instance
  and you have obtained permission.
* **Forks of the yipyip source code.** Forks that diverge from upstream must use
  a different name. You may state that your fork is "based on yipyip" or "a fork
  of yipyip," but the project name itself must be your own.

## Statements about your software's relation to yipyip

You may use the word mark, but not yipyip logos, to truthfully describe the
relationship between your software and ours. The word mark "yipyip" should be
used after a verb or preposition that describes the relationship between your
software and ours. So you may say, for example, "Bob's app for yipyip" but may
not say "Bob's yipyip app." Some other examples that may work for you are:

* [Your software] uses yipyip
* [Your software] is powered by yipyip
* [Your software] runs on yipyip
* [Your software] for use with yipyip
* [Your software] for yipyip
...
is not covered, please open an issue on the yipyip GitHub repository or contact
