...
git clone -b dev git@github.com:your-username/yipyip.git
cd yipyip
```
...
```bash
git remote add upstream git@github.com:mauriceboe/yipyip.git
```
...
| Remote     | URL                                          | Purpose                        |
|------------|----------------------------------------------|--------------------------------|
| `origin`   | `git@github.com:your-username/yipyip.git`      | Your fork — push changes here  |
| `upstream` | `git@github.com:mauriceboe/yipyip.git`         | Main repo — pull updates from here |
...
Then open a Pull Request from your fork to `mauriceboe/yipyip` targeting the `dev` branch. If your PR only modifies files under `wiki/`, it is exempt from branch enforcement and may target any branch.
