import { SUPPORTED_LANGUAGE_CODES as SUPPORTED_LANG_CODES } from '@yipyip/shared';
...
// SESSION_DURATION controls how long a yipyip session (the `yipyip_session` JWT
...
// persistent `yipyip_session` cookie `maxAge`. An unticked login keeps
