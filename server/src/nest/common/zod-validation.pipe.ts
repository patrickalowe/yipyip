...
/**
 * Validates an incoming @Body()/@Query() against a Zod schema (from @yipyip/shared)
 * and returns the parsed, typed value. On failure it throws yipyip's error envelope
