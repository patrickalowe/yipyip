...
/**
 * Normalises every Nest exception to yipyip's legacy error envelope so migrated
 ...
 */
@Catch()
export class YipyipExceptionFilter implements ExceptionFilter {
    ...
    if (exception instanceof HttpException) {
      ...
      if (body && typeof body === 'object') {
        ...
        // yipyip-native shape ({ error } / { error, code } from guards + the Zod
