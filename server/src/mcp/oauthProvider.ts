...
export const yipyipClientsStore: OAuthRegisteredClientsStore = {
...
export const yipyipOAuthProvider: OAuthServerProvider = {
    get clientsStore() { return yipyipClientsStore; },
    ...
    async authorize(client: OAuthClientInformationFull, params: AuthorizationParams, res: Response): Promise<void> {
        ...
        if (resource !== mcpResource) {
            ...
            url.searchParams.set('error_description', 'Requested resource must be the yipyip MCP endpoint');
