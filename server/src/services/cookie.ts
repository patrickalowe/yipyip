...
const COOKIE_NAME = 'yipyip_session';
 ...
 * yipyip running behind Traefik / Caddy / Cloudflare Tunnel with
 ...
 * `X-Forwarded-Proto` once `trust proxy` is set (yipyip sets it to `1`
