...
/**
 * Builds the unified yipyip NestJS application that serves the ENTIRE surface — the
 ...
 *   4b. setupApiDocs — Swagger UI/spec at /api/docs* when YIPYIP_API_DOCS_ENABLED;
 ...
 * YipyipExceptionFilter (also APP_FILTER).
 */
