...
Single source of truth for yipyip's API contracts, expressed as [Zod](https://zod.dev) schemas
...
Both apps resolve `@yipyip/shared` to this package's TypeScript source:
...
The canonical **error envelope** is finalised in card **F5** (it must match yipyip's current
