...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'yipyipの旅仲間',
  'settings.about.supporters.subtitle': '皆さんの支援がyipyipの未来を支えています。',
  ...
  'settings.about.description': 'yipyipはセルフホスト型の旅行プランナーです。',
  ...
  'settings.airtrail.writeBackHint':
    '既定ではオフ: AirTrail が信頼できる情報源で、yipyip は読み取りのみを行います。yipyip で行った編集を AirTrail に書き戻すにはオンにします。',
