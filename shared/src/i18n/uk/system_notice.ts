...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Ласкаво просимо в yipyip',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописне місце призначення з інтерфейсом yipyip',
  ...
  'system_notice.thank_you_support.title': 'Дякую, що користуєтесь yipyip',
  'system_notice.thank_you_support.body':
    'Невелика подяка за те, що встановили yipyip — для мене це справді багато значить.\n\nЯ розробник-одинак і створюю yipyip у вільний час. Усе почалося як маленький інструмент для моїх власних поїздок, і відтоді я щиро вражений підтримкою та інтересом спільноти. yipyip зроблено з великою любов’ю з мого боку — але також завдяки багатьом чудовим зовнішнім контриб’юторам, які допомогли його сформувати.\n\n**yipyip має відкритий код і повністю безкоштовний — і таким залишиться назавжди. Жодних платних тарифів, жодних підписок, жодних підводних каменів. Обіцяю.**\n\nЯкщо yipyip корисний для вас і ви хочете підтримати його розробку, невелика кава справді допомагає мені продовжувати — жодного тиску, але кожна чашка підтримує ці пізні ночі.\n\nДякую, що ви тут.\n\n— Maurice',
  ...
  'system_notice.v3_mcp.body':
    'Інтеграція MCP була повністю перероблена. OAuth 2.1 тепер є рекомендованим методом автентифікації. Статичні токени (yipyip_…) застаріли і будуть видалені в майбутній версії.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Статичні токени yipyip_ застаріли',
