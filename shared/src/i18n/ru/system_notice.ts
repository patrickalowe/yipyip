...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Добро пожаловать в yipyip',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописное место назначения с интерфейсом yipyip',
  ...
  'system_notice.thank_you_support.title': 'Спасибо, что выбрали yipyip',
  'system_notice.thank_you_support.body':
    'Небольшое спасибо за то, что установили yipyip — для меня это правда очень много значит.\n\nЯ разработчик-одиночка и делаю yipyip в свободное время. Всё началось как маленький инструмент для моих собственных поездок, и я, честно говоря, поражён той поддержкой и интересом, которые проявило сообщество с тех пор. yipyip создаётся с большой любовью с моей стороны — но также благодаря множеству замечательных внешних участников, которые помогли его сформировать.\n\n**yipyip — это открытый исходный код и полностью бесплатно — и так будет всегда. Никаких платных тарифов, никаких подписок, никаких подвохов. Обещаю.**\n\nЕсли yipyip вам полезен и вы хотите поддержать его развитие, маленький кофе по-настоящему помогает мне продолжать — без всякого давления, но каждая чашка даёт силы для поздних ночей.\n\nСпасибо, что вы здесь.\n\n— Maurice',
  ...
  'system_notice.v3_mcp.body':
    'Интеграция MCP была полностью переработана. OAuth 2.1 теперь является рекомендуемым методом аутентификации. Статические токены (yipyip_…) устарели и будут удалены в будущей версии.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Статические токены yipyip_ устарели',
