...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Среда выполнения плагинов выключена (YIPYIP_PLUGINS_ENABLED). Плагины не смогут работать, пока администратор не включит её в конфигурации сервера.',
  ...
  'admin.plugins.requiresYipyip': 'Требуется yipyip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '«Проверен» означает, что сопровождающий yipyip проверял этот плагин на вредоносный код в каждой версии — но не его качество или работоспособность. Это не гарантия того, что плагин безвреден.',
  ...
  'admin.plugins.security.reviewedBody':
    'Проверенный плагин был вручную просканирован на вредоносный код сопровождающим yipyip в каждой версии — проверен на вредоносный код, а не на то, насколько хорошо он работает. Это не обещание того, что плагин безвреден.',
  'admin.plugins.security.trustTitle': 'Итог',
  'admin.plugins.security.trustBody':
    'Установка плагина похожа на установку любого стороннего приложения: добавляйте только код от авторов, которым доверяете, а при сомнениях сначала проверьте его самостоятельно. yipyip не несёт ответственности за сторонние плагины.',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки yipyip под себя.',
  ...
  'admin.weather.description':
    'yipyip использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку yipyip',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',
  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия yipyip {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'yipyip будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText':
    'Ваш экземпляр yipyip работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  'admin.update.nonDockerText':
    'Этот экземпляр yipyip работает не в Docker. Чтобы обновиться до {version}, повторно запустите способ установки или обновления, который вы использовали, — например, в Proxmox Community Scripts выполните обновление из консоли LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Голый домен, к которому привязаны passkeys, напр. yipyip.example.org. Оставьте пустым, чтобы определить его из APP_URL. Последующее изменение делает существующие passkeys недействительными.',
  'admin.passkey.origins': 'Разрешённые источники',
  'admin.passkey.originsHint':
    'Полные источники через запятую, напр. https://yipyip.example.org. Оставьте пустым, чтобы использовать APP_URL.',
