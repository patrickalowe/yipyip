...
const trip: TranslationStrings = {
  ...
  'trip.invite.linkHint':
    'Cualquier persona con una cuenta de yipyip que abra este enlace se unirá al viaje como miembro. Regenéralo para invalidar el enlace anterior.',
