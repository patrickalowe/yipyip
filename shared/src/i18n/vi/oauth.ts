...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} muốn truy cập vào tài khoản yipyip của bạn. Vui lòng đăng nhập trước.',
  'oauth.authorize.loginButton': 'Đăng nhập vào yipyip',
  'oauth.authorize.requestLabel': 'Yêu cầu ủy quyền',
  'oauth.authorize.requestDescription': 'Ứng dụng này đang yêu cầu quyền truy cập vào tài khoản yipyip của bạn.',
