...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do yipyip',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário yipyip',
  ...
  'vacay.inviteHint': 'Convide outro usuário yipyip para compartilhar um calendário de férias combinado.',
