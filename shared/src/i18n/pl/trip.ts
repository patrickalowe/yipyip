...
const trip: TranslationStrings = {
  ...
  'trip.invite.linkHint':
    'Każda osoba z kontem yipyip, która otworzy ten link, dołączy do podróży jako członek. Wygeneruj ponownie, aby unieważnić stary link.',
