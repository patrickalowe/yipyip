...
const admin: TranslationStrings = {
  ...
  'admin.plugins.disabledBody':
    'Το περιβάλλον εκτέλεσης plugins είναι απενεργοποιημένο (YIPYIP_PLUGINS_ENABLED). Κανένα plugin δεν μπορεί να εκτελεστεί μέχρι ένας διαχειριστής να το ενεργοποιήσει στη διαμόρφωση του server.',
  ...
  'admin.plugins.requiresYipyip': 'Απαιτεί yipyip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    'Το "Ελεγμένο" σημαίνει ότι ένας συντηρητής του yipyip σάρωσε αυτό το plugin για κακόβουλο λογισμικό σε κάθε έκδοση — όχι για την ποιότητα ή για το αν λειτουργεί. Δεν αποτελεί εγγύηση ότι ένα plugin είναι ακίνδυνο.',
  ...
  'admin.plugins.security.reviewedBody':
    'Ένα ελεγμένο plugin σαρώθηκε χειροκίνητα για κακόβουλο λογισμικό από έναν συντηρητή του yipyip σε κάθε έκδοση — ελέγχθηκε για εχθρικό κώδικα, όχι για το αν λειτουργεί καλά. Δεν αποτελεί υπόσχεση ότι το plugin είναι ακίνδυνο.',
  'admin.plugins.security.trustTitle': 'Το συμπέρασμα',
  'admin.plugins.security.trustBody':
    'Η εγκατάσταση ενός plugin είναι σαν την εγκατάσταση οποιασδήποτε εφαρμογής τρίτου: προσθέστε κώδικα μόνο από δημιουργούς που εμπιστεύεστε, και σε περίπτωση αμφιβολίας, ελέγξτε τον πρώτα μόνοι σας. Το yipyip δεν αναλαμβάνει καμία ευθύνη για plugins τρίτων.',
  ...
  'admin.addons.subtitle':
    'Ενεργοποιήστε ή απενεργοποιήστε λειτουργίες για να εξατομικεύσετε την εμπειρία σας στο yipyip.',
  ...
  'admin.weather.description':
    'Το yipyip χρησιμοποιεί το Open-Meteo ως πηγή δεδομένων καιρού. Το Open-Meteo είναι μια δωρεάν, ανοιχτού κώδικα υπηρεσία καιρού — δεν απαιτείται κλειδί API.',
  ...
  'admin.github.by': 'από',
  'admin.github.support': 'Βοηθά να συνεχίσω την ανάπτυξη του yipyip',
  'admin.update.available': 'Διαθέσιμη ενημέρωση',
  'admin.update.text': 'Το yipyip {version} είναι διαθέσιμο. Εκτελείτε το {current}.',
  ...
  'admin.update.confirmText':
    'Το yipyip θα ενημερωθεί από {current} σε {version}. Ο server θα επανεκκινήσει αυτόματα στη συνέχεια.',
  ...
  'admin.update.dockerText':
    'Η εγκατάστασή σας yipyip εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε τις ακόλουθες εντολές στον server σας:',
  'admin.update.nonDockerText':
    'Αυτή η εγκατάσταση yipyip δεν εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε ξανά τη μέθοδο εγκατάστασης ή ενημέρωσης που χρησιμοποιήσατε — για παράδειγμα, στα Proxmox Community Scripts εκτελέστε την ενημέρωση από την κονσόλα LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Ο σκέτος τομέας στον οποίο δεσμεύονται τα passkeys, π.χ. yipyip.example.org. Αφήστε το κενό για να παραχθεί από το APP_URL. Η μεταγενέστερη αλλαγή του ακυρώνει τα υπάρχοντα passkeys.',
  'admin.passkey.origins': 'Επιτρεπόμενες προελεύσεις',
  'admin.passkey.originsHint':
    'Πλήρεις προελεύσεις χωρισμένες με κόμμα, π.χ. https://yipyip.example.org. Αφήστε το κενό για χρήση του APP_URL.',
