...
const places: TranslationStrings = {
  ...
  'places.gpxImportTracks': 'yipyip (dengan geometri jalur)',
  ...
  'places.formRecommendedBy': 'Direkomendasikan oleh',
  'places.formRecommendedByPlaceholder': 'TikTok, Reddit, nama teman...',
  'places.recommendedByVia': 'via {source}',
