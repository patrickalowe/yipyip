...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Selamat datang di yipyip',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinasi wisata indah dengan antarmuka yipyip',
  ...
  'system_notice.thank_you_support.title': 'Terima kasih telah memakai yipyip',
  'system_notice.thank_you_support.body':
    'Sekadar ucapan terima kasih singkat karena telah memasang yipyip — ini benar-benar berarti banyak bagi saya.\n\nSaya seorang developer solo dan membangun yipyip di waktu luang. Awalnya hanya alat kecil untuk perjalanan saya sendiri, dan sejujurnya saya terharu dengan dukungan serta minat dari komunitas sejak saat itu. yipyip dibuat dengan sepenuh hati dari saya — tetapi juga berkat banyak kontributor eksternal hebat yang telah membantu membentuknya.\n\n**yipyip bersifat open source dan sepenuhnya gratis — dan akan selalu begitu, selamanya. Tanpa paket berbayar, tanpa langganan, tanpa syarat tersembunyi. Saya janji.**\n\nJika yipyip bermanfaat bagimu dan kamu ingin mendukung pengembangannya, secangkir kopi kecil sungguh membantu saya untuk terus membangun — sama sekali tanpa paksaan, tapi setiap cangkir membuat malam-malam panjang ini tetap berjalan.\n\nTerima kasih telah berada di sini.\n\n— Maurice',
  ...
  'system_notice.v3_photos.body':
    '**Foto** di Perencana Perjalanan telah dihapus. Foto Anda aman — yipyip tidak pernah mengubah perpustakaan Immich atau Synology Anda.\n\nFoto kini ada di addon **Journey**. Journey bersifat opsional — jika belum tersedia, minta admin untuk mengaktifkannya di Admin → Addon.',
  ...
  'system_notice.v3_mcp.body':
    'Integrasi MCP telah sepenuhnya diperbarui. OAuth 2.1 kini menjadi metode autentikasi yang direkomendasikan. Token statis (yipyip_…) sudah usang dan akan dihapus pada versi mendatang.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Token statis yipyip_ sudah usang',
