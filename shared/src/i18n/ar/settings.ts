...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'رفاق رحلة yipyip',
  'settings.about.supporters.subtitle':
    'بينما تخطّط لمسارك التالي، يساعد هؤلاء الأشخاص في التخطيط لمستقبل yipyip. تذهب مساهمتهم الشهرية مباشرةً إلى التطوير والساعات الفعلية المبذولة — حتى يظلّ yipyip مفتوح المصدر.',
  'settings.about.supporters.since': 'داعم منذ {date}',
  'settings.about.supporters.tierEmpty': 'كن الأول',
  'settings.about.description':
    'yipyip هو مخطط سفر مستضاف ذاتيًا يساعدك على تنظيم رحلاتك من أول فكرة حتى آخر ذكرى. تخطيط يومي، ميزانية، قوائم تعبئة، صور والمزيد — كل شيء في مكان واحد، على خادمك الخاص.',
  ...
  'settings.ntfyUrl.topicPlaceholder': 'my-yipyip-alerts', // en-fallback
  ...
  'settings.airtrail.writeBackHint':
    'مُعطّل افتراضيًا: AirTrail هو مصدر الحقيقة وyipyip يقرأ منه فقط. فعّله لإرسال التعديلات التي تجريها في yipyip إلى AirTrail.',
