...
export const airtrailSettingsSchema = z.object({
  /** Instance origin, e.g. https://flights.example.com — yipyip appends /api itself. */
  ...
  /**
   * Opt in to writing yipyip edits back to AirTrail (#1240). Off by default:
   * AirTrail is the source of truth and yipyip only reads from it.
   */
