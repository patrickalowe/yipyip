...
import { sanitizeRichTextHtml } from '@yipyip/shared'
...
<body>
  ...
  <div class="cover-page">
    ...
    <div class="cover-footer">Made with yipyip</div>
  </div>
  ...
  <div class="closing-page">
    <div>
      ...
      <div class="closing-sub">Made with yipyip · ${new Date().getFullYear()}</div>
    </div>
  </div>
