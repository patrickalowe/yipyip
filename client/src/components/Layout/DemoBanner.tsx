...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur yipyip Demo',
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the yipyip Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de yipyip',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من yipyip',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo yipyip',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 'calc(17px * var(--fs-scale-subtitle, 1))', fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: 5 }}>
            {t.titleBefore}<img src="/text-dark.svg" alt="yipyip" style={{ height: 18 }} />{t.titleAfter}
          </h2>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 'calc(11px * var(--fs-scale-caption, 1))', color: '#9ca3af' }}>
            ...
            <a href="https://github.com/patrickalowe/yipyip" target="_blank" rel="noopener noreferrer"
