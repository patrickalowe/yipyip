...
describe('AdminMcpTokensPanel', () => {
  ...
  it('FE-ADMIN-MCP-003: token list renders correctly', async () => {
    ...
    expect(screen.getByText(/yipyip_abc/)).toBeInTheDocument();
    expect(screen.getByText(/yipyip_xyz/)).toBeInTheDocument();
  });
