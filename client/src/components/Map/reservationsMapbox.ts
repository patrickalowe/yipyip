...
import { escapeHtml } from '@yipyip/shared'
import type { Reservation, ReservationEndpoint } from '../../types'

export const RESERVATION_SOURCE_ID = 'yipyip-reservations'
export const RESERVATION_LINE_LAYER_ID = 'yipyip-reservations-lines'
...
function buildStatsHtml(mainLabel: string | null, subLabel: string | null): { html: string; width: number; height: number } {
  ...
  const html = `<div class="yipyip-stats-inner" style="
  ...
  private updateStatsRotation = () => {
    ...
    for (const entry of this.statsMarkers) {
      ...
      try {
        ...
        const inner = el.querySelector('.yipyip-stats-inner') as HTMLElement | null
