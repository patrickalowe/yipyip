...
import en from '@yipyip/shared/i18n/en'
import type { SupportedLanguageCode } from '@yipyip/shared'
import {
  SUPPORTED_LANGUAGES,
...
import type { TranslationStrings } from '@yipyip/shared/i18n'
...
const localeLoaders: Record<SupportedLanguageCode, () => Promise<{ default: TranslationStrings }>> = {
  ...
  de:      () => import('@yipyip/shared/i18n/de'),
  es:      () => import('@yipyip/shared/i18n/es'),
  fr:      () => import('@yipyip/shared/i18n/fr'),
  hu:      () => import('@yipyip/shared/i18n/hu'),
  it:      () => import('@yipyip/shared/i18n/it'),
  tr:      () => import('@yipyip/shared/i18n/tr'),
  ru:      () => import('@yipyip/shared/i18n/ru'),
  zh:      () => import('@yipyip/shared/i18n/zh'),
  'zh-TW': () => import('@yipyip/shared/i18n/zh-TW'),
  nl:      () => import('@yipyip/shared/i18n/nl'),
  id:      () => import('@yipyip/shared/i18n/id'),
  ar:      () => import('@yipyip/shared/i18n/ar'),
  br:      () => import('@yipyip/shared/i18n/br'),
  cs:      () => import('@yipyip/shared/i18n/cs'),
  pl:      () => import('@yipyip/shared/i18n/pl'),
  ja:      () => import('@yipyip/shared/i18n/ja'),
  ko:      () => import('@yipyip/shared/i18n/ko'),
  uk:      () => import('@yipyip/shared/i18n/uk'),
  gr:      () => import('@yipyip/shared/i18n/gr'),
  sv:      () => import('@yipyip/shared/i18n/sv'),
  vi:      () => import('@yipyip/shared/i18n/vi'),
}
