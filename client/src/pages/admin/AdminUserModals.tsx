          ...
          >
            ...
            <div style={{ padding: '20px 24px' }}>
              ...
              {updateInfo?.is_docker === false ? (
                ...
                >
{`docker pull mauriceboe/yipyip:latest
docker stop yipyip && docker rm yipyip
docker run -d --name yipyip \\
  -p 3000:3000 \\
  -v /opt/yipyip/data:/app/data \\
  -v /opt/yipyip/uploads:/app/uploads \\
