        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="yipyip.example.org"
          ...
          <div>
            ...
            <input
              ...
              placeholder="https://yipyip.example.org"
              className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-400 focus:border-transparent"
            />
          </div>
          <button
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder='https://auth.example.com/application/o/yipyip/.well-known/openid-configuration'
              className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-slate-400 focus:border-transparent"
            />
